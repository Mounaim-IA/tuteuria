    ...
    (function() {{
        function styleBtns() {{
            ...
            doc.querySelectorAll('button').forEach(function(btn) {{
                ...
                // MODIFICATION : width passe à 100% pour remplir la colonne fixe
            ...
            if (targetRow) {{
                ...
                targetRow.style.setProperty('margin-bottom', '15px', 'important'); 
                
                var cols = targetRow.querySelectorAll('div[data-testid="column"]');
                cols.forEach(function(c) {{
                    // MODIFICATION : Les deux colonnes sont forcées à la même taille (160px)
                    c.style.setProperty('width', '160px', 'important'); 
                    c.style.setProperty('max-width', '160px', 'important'); 
                    c.style.setProperty('flex', '0 1 160px', 'important'); 
