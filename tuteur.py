...
# ============================================================
lbl_new   = "🔄 Nouveau" if langue_choisie == "Français" else "🔄 جديد"
lbl_print = "⬇️ PDF" if langue_choisie == "Français" else "⬇️ PDF"

# CSS boutons icônes carrés identiques côte à côte
st.markdown("""
<style>
...
with col_n:
    if st.button(lbl_new, use_container_width=False, key="btn_new"):
