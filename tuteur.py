...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            ...
            "Écris ton <span style=\"color:#FFF000; font-weight:600;\">prénom</span>, "
            "choisis ton <span style=\"color:#FFD93D; font-weight:600;\">niveau</span>, "
            "puis clique sur <span style=\"color:#1A2A6C; font-weight:600;\">Commencer</span> pour débuter !"
            "</span>"
        )
    else:
        titre_html = (
