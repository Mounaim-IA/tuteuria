...
(function() {{
    function styleBtns() {{
        ...
        // L'AIMANT CENTRAL (Regroupe les colonnes au milieu)
        if (targetRow) {{
            ...
            targetRow.style.setProperty('justify-content', 'center', 'important'); /* Centre tout le bloc */
            ...
            cols.forEach(function(c) {{
                ...
                c.style.setProperty('max-width', '140px', 'important'); /* Limite la largeur pour les forcer à se rapprocher */
                c.style.setProperty('min-width', '0px', 'important');
                c.style.setProperty('flex', '0 1 140px', 'important');  /* Empêche les colonnes de s'étirer à l'infini */
