...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            ...
            "Écris ton <span style='color: #FFDE21;'>prénom</span>, "
            "choisis ton <span style='color: #FFDE21;'>niveau</span>, "
            "puis clique sur <span style='color: #FFDE21;'>Commencer</span> pour débuter !"
            "</div>"
        )
    else:
        titre_html = (
            ...
            "اكتب <span style='color: #FFDE21;'>اسمك</span>، "
            "اختر <span style='color: #FFDE21;'>مستواك</span>، "
            "ثم اضغط على <span style='color: #FFDE21;'>ابدأ</span> للبدء!"
            "</div>"
        )
