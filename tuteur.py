...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            "<div style='color: white; font-family: sans-serif; line-height: 1.5;'>"
            "👋 Bienvenue ! Je suis ton tuteur IA en mathématiques.<br>"
        ...
        titre_html = (
            "<div style='color: white; font-family: sans-serif; line-height: 1.5;'>"
            "👋 مرحباً بك! أنا معلمك الذكي في الرياضيات.<br>"
