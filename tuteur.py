...
<div style="
    ...
    line-height: 1.8;
">
    👋 <strong>Bienvenue !</strong> Pour commencer ta leçon :<br>
    &nbsp;&nbsp;① Écris ton <strong>prénom</strong><br>
    &nbsp;&nbsp;② Sélectionne ton <strong>niveau scolaire</strong><br>
    &nbsp;&nbsp;③ Clique sur <strong>🚀 Commencer la discussion</strong>
</div>"""
    else:
        guide_msg = """
<div style="
    ...
    text-align: right;
" dir="rtl">
    👋 <strong>مرحباً !</strong> لبدء الدرس :<br>
    &nbsp;&nbsp;① اكتب <strong>اسمك</strong><br>
    &nbsp;&nbsp;② اختر <strong>مستواك الدراسي</strong><br>
    &nbsp;&nbsp;③ انقر على <strong>🚀 لنبدأ النقاش</strong>
</div>"""
    st.markdown(guide_msg, unsafe_allow_html=True)
...
# ============================================================
# 17. FOOTER — Design original avec lien cliquable TuteurIA
# ============================================================
st.markdown(f"""
<style>
.footer-text {{
...
.footer-text a {{
    ...
    cursor: pointer;
    border-bottom: 1px dotted #764ba2;
    padding-bottom: 1px;
    transition: all 0.2s;
}}
.footer-text a:hover {{
