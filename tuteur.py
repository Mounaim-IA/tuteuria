...
def post_traitement(reply, user_input, historique, langue):
    ...
    mots_fr = ['bravo', 'correct', 'exact', 'parfait', 'excellent', 'très bien', 'super', 'juste',
               'courageux', 'bien essayé', 'bien tenté', 'bonne tentative', 'pas tout à fait',
               'pas loin', 'presque', 'essaie encore', 'on apprend']
    mots_ar = ['أحسنت', 'صحيح', 'ممتاز', 'رائع', 'جيد', 'شجاع', 'محاولة', 'قريب', 'حاول']
