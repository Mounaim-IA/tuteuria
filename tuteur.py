...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            ...
            "Écris ton <span style='color: #FF9A3C;'>prénom</span>, "
            "choisis ton <span style='color: #FF9A3C;'>niveau</span>, "
            "puis clique sur <span style='color: #FF9A3C;'>Commencer</span> pour débuter !"
            "</div>"
        )
    else:
        titre_html = (
            ...
            "اكتب <span style='color: #FF9A3C;'>اسمك</span>، "
            "اختر <span style='color: #FF9A3C;'>مستواك</span>، "
            "ثم اضغط على <span style='color: #FF9A3C;'>ابدأ</span> للبدء!"
            "</div>"
        )
