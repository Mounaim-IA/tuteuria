...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            "<div style='color: #FFD93D; font-family: sans-serif;'>"
            "<strong>👋 Bienvenue ! Je suis ton tuteur IA en mathématiques.</strong><br>"
            "Écris ton prénom, choisis ton niveau, puis clique sur Commencer pour débuter !"
            "</div>"
        )
    else:
        # Fais la même chose pour l'arabe si besoin
        titre_html = (
            "<div style='color: #FFD93D; font-family: sans-serif;'>"
            "<strong>👋 مرحباً بك! أنا معلمك الذكي في الرياضيات.</strong><br>"
            "اكتب اسمك، اختر مستواك، ثم اضغط على ابدأ للبدء!"
            "</div>"
        )
