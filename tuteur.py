...
(function() {{
    function styleBtns() {{
        ...
        doc.querySelectorAll('button').forEach(function(btn) {{
            ...
            // STYLE ALIGNÉ SUR LE BOUTON "ENVOYER"
            btn.setAttribute('style',
                'background: linear-gradient(135deg, #FF6B6B, #FFE66D) !important;' + /* Même dégradé */
                'color: #333 !important;' + /* Texte sombre pour le contraste */
                'border: none !important;' +
                'border-radius: 50px !important;' + 
                'font-family: Fredoka One, cursive !important;' +
                'font-size: 0.95rem !important;' + 
            ...
            btn.querySelectorAll('p, span, div').forEach(function(el) {{
                el.style.cssText = 'margin:0 !important;padding:0 !important;text-align:center !important;width:100% !important;color:#333 !important;font-size:inherit !important;overflow:hidden !important;text-overflow:ellipsis !important;white-space:nowrap !important;';
            }});
        ...
        if (targetRow) {{
            ...
            targetRow.style.setProperty('gap', '15px', 'important'); 
