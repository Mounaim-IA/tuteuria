...
(function() {{
    function styleBtns() {{
        ...
        if (targetRow) {{
            ...
            /* LA SOLUTION : Deux colonnes de 140px max, qui rétrécissent si besoin (minmax 0) */
            targetRow.style.setProperty('grid-template-columns', 'minmax(0, 140px) minmax(0, 140px)', 'important'); 
            
            /* On regroupe ces deux colonnes bien au centre de l'écran */
            targetRow.style.setProperty('justify-content', 'center', 'important'); 
            
            targetRow.style.setProperty('gap', '8px', 'important'); /* Espace propre entre les deux */
