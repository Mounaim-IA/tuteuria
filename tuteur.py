    ...
    function styleBtns() {{
        ...
        doc.querySelectorAll('button').forEach(function(btn) {{
            ...
            btn.setAttribute('style',
                ...
                'align-items:center !important;' +
                'justify-content:center !important;' +
                'padding:8px 2px !important;' + /* Padding réduit pour faire respirer le texte */
                'width:100% !important;' +
        ...
        // 3. LE RECENTRAGE PARFAIT SANS DÉBORDEMENT
        if (targetRow) {{
            ...
            targetRow.style.setProperty('gap', '4px', 'important');           /* Espace entre les boutons */
            targetRow.style.setProperty('width', '100%', 'important');
            targetRow.style.setProperty('max-width', '100%', 'important');
            targetRow.style.setProperty('padding', '0 15px', 'important');     /* Marge de sécurité pour ne pas coller à l'écran */
            ...
            cols.forEach(function(c) {{
                ...
                c.style.setProperty('flex', '0 1 auto', 'important'); /* LA SOLUTION MATHÉMATIQUE (Partage strict sans dépassement) */
