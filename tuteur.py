...
(function() {{
    function styleBtns() {{
        ...
        doc.querySelectorAll('button').forEach(function(btn) {{
            ...
            // 1. Centrer le bouton dans son conteneur Streamlit
            ...
            // 2. DIMINUER LA TAILLE PHYSIQUE DU BOUTON
            btn.setAttribute('style',
                ...
                'justify-content:center !important;' +
                'padding:8px 10px !important;' +
                'width:90% !important;' +         /* Le bouton ne prend plus 100% de la place */
                'max-width:140px !important;' +   /* LIMITE STRICTE : il ne sera jamais trop large */
                'margin:0 auto !important;' +     /* Garde le bouton bien au centre */
                'white-space:nowrap !important;' +
        ...
        // 3. Organisation de la ligne pour accueillir les petits boutons
        if (targetRow) {{
            ...
            targetRow.style.setProperty('gap', '10px', 'important');
            targetRow.style.setProperty('width', '100%', 'important');
            targetRow.style.setProperty('max-width', '100vw', 'important'); /* Anti-débordement */
