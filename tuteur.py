...
(function() {{
    function styleBtns() {{
        ...
        doc.querySelectorAll('button').forEach(function(btn) {{
            ...
            // STYLE IDENTIQUE AUX BOUTONS DE LANGUES
            btn.setAttribute('style',
                'background:#4ECDC4 !important;' +
                'color:white !important;' +
                'border:none !important;' +
                'border-radius:50px !important;' + /* Bords très arrondis (pilule) */
                'font-family:Fredoka One,cursive !important;' +
                'font-size:clamp(0.75rem, 2vw, 0.95rem) !important;' + /* Taille alignée sur les langues */
                'display:flex !important;' +
                'align-items:center !important;' +
                'justify-content:center !important;' +
                'padding:8px 12px !important;' + 
        ...
        if (targetRow) {{
            ...
            /* LA SOLUTION PC : Limite à 160px max pour les garder petits et proches au centre */
            targetRow.style.setProperty('grid-template-columns', 'minmax(0, 160px) minmax(0, 160px)', 'important'); 
            
            targetRow.style.setProperty('justify-content', 'center', 'important'); 
            targetRow.style.setProperty('gap', '15px', 'important'); /* Espace élégant de 15px */
