...
(function() {{
    function styleBtns() {{
        ...
        doc.querySelectorAll('button').forEach(function(btn) {{
            ...
            // STYLE "AUTO-AJUSTABLE" : Le bouton moule parfaitement le texte !
            btn.setAttribute('style',
                'background: linear-gradient(135deg, #FF6B6B, #FFE66D) !important;' + 
                'color: #333 !important;' +
                'border: none !important;' +
                ...
                'align-items: center !important;' +
                'justify-content: center !important;' +
                'padding: 8px 24px !important;' + /* Des bords larges et élégants */
                'width: max-content !important;' + /* LE SECRET : S'adapte au mot ! */
                'max-width: 100% !important;' +
                'margin: 0 !important;' +
                'white-space: nowrap !important;' +
        ...
        if (targetRow) {{
            // On repasse en mode Flexbox "élastique"
            targetRow.style.setProperty('display', 'flex', 'important');
            targetRow.style.setProperty('flex-direction', 'row', 'important');
            
            /* Si l'écran d'un téléphone est VRAIMENT minuscule, 
               les boutons se mettront l'un sous l'autre pour ne pas se couper ! */
            targetRow.style.setProperty('flex-wrap', 'wrap', 'important'); 
            ...
            cols.forEach(function(c) {{
                c.style.setProperty('width', 'auto', 'important'); /* Colonne ajustable */
                c.style.setProperty('flex', '0 1 auto', 'important'); 
