...
if user_input:
    ...
    if etape_actuelle == "amorce":
        ...
        # ── DEBUG TEMPORAIRE ──
        st.warning(f"🔍 DEBUG: etape={etape_actuelle}, operation={operation}, calcul={calcul}, generique={est_question_generique(user_input) if operation else 'N/A'}")
