                        ...
                        if _img_path and _choix_consigne and etape_actuelle in ("explication", "choix_sujet"):
                            ...
                            if langue_choisie == "العربية":
                                consigne_specifique = (
                                    ...
                                    f"3) اختم OBLIGATOIREMENT بـ : '✏️ دورك ! كم يساوي {_exercice_final_ar} ؟ 🤔' — استخدم هذه الأرقام بالضبط، لا تغيّرها. ]"
                                )
                            else:
                                consigne_specifique = (
                                    ...
                                    f"3) Termine OBLIGATOIREMENT par : '✏️ À toi ! Combien font {_exercice_final} ? 🤔' — utilise EXACTEMENT ces chiffres, ne les change pas. ]\""
                                )
