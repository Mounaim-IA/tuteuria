...
(function() {{
    function styleBtns() {{
        ...
        doc.querySelectorAll('button').forEach(function(btn) {{
            ...
            // Style ajusté pour mobile sans déborder
            btn.setAttribute('style',
                ...
                'width:100% !important;' +
                'white-space:normal !important;' + /* AUTORISE LE TEXTE À S'AJUSTER SI BESOIN */
        ...
        // Force l'affichage côte à côte 50/50 sans déborder
        if (targetBlock) {{
            ...
            targetBlock.style.setProperty('gap', '8px', 'important');
            ...
            cols.forEach(c => {{
                ...
                c.style.setProperty('padding', '0', 'important'); // Supprime les marges de Streamlit
            }});
        }}
    }}
