...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            "<span style=\"font-size:1.1rem; font-weight:700; color:white;\">👋 Bienvenue ! Je suis ton tuteur IA en mathématiques.</span><br>"
            "<span style=\"font-size:0.9rem; font-weight:400; color:white; opacity:0.95;\">"
            "Écris ton <span style=\"color:#FF9A3C; font-weight:700;\">prénom</span>, "
            "choisis ton <span style=\"color:#FF9A3C; font-weight:700;\">niveau</span>, "
            "puis clique sur <span style=\"color:#FF9A3C; font-weight:700;\">Commencer</span> pour débuter !"
            "</span>"
        )
    else:
        titre_html = (
            "<span style=\"font-size:1.1rem; font-weight:700; color:white;\">👋 مرحباً بك! أنا معلمك الذكي في الرياضيات.</span><br>"
            "<span style=\"font-size:0.9rem; font-weight:400; color:white; opacity:0.95;\">"
            "اكتب <span style=\"color:#FF9A3C; font-weight:700;\">اسمك</span>، "
            "اختر <span style=\"color:#FF9A3C; font-weight:700;\">مستواك</span>، "
            "ثم اضغط على <span style=\"color:#FF9A3C; font-weight:700;\">ابدأ</span> للبدء!"
            "</span>"
        )
