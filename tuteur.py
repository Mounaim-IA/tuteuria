                        ...
                        if _img_path and _choix_consigne and etape_actuelle in ("explication", "choix_sujet"):
                            ...
                            if langue_choisie == "العربية":
                                consigne_specifique = (
                                    ...
                                    f"3) قل للتلميذ : 'انظر إلى الصورة ! 😊 هذه مثال — طبّق نفس الخطوات بأرقامك {_exercice_final_ar}.' واختم بـ '✏️ دورك ! كم يساوي {_exercice_final_ar} ؟ 🤔' ]"
                                )
                            else:
                                consigne_specifique = (
                                    ...
                                    f"3) Dis à l'élève : 'Regarde bien l'image ! 😊 C'est un EXEMPLE — applique ces mêmes étapes avec TES chiffres {_exercice_final}.' puis termine par '✏️ À toi ! Combien font {_exercice_final} ? 🤔' ]\""
                                )
