...
st.markdown("""
<div class="header-fixed" dir="ltr">
    <span class="header-icon">🧮</span>
    <div>
        <div class="header-title">Tuteur Maths Primaire</div>
        <div class="header-subtitle">Cycle Primaire — 1ère à 6ème année</div>
    </div>
</div>
""", unsafe_allow_html=True)

# ── Sélecteur langue centré sous le titre ──────────
st.markdown('<div style="text-align:center; margin: 6px 0 4px 0;">🌐</div>', unsafe_allow_html=True)
