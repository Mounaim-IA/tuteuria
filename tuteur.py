...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            "<span style=\"font-size:1.1rem; font-weight:700; color:#1a1a2e;\">👋 Bienvenue ! Je suis ton tuteur IA en mathématiques.</span><br>"
            "<span style=\"font-size:0.9rem; font-weight:400; color:#1a1a2e; opacity:0.95;\">"
            "Écris ton prénom, choisis ton niveau, puis clique sur <b>Commencer</b> pour débuter !"
            "</span>"
        )
    else:
        titre_html = (
            "<span style=\"font-size:1.1rem; font-weight:700; color:#1a1a2e;\">👋 مرحباً بك! أنا معلمك الذكي في الرياضيات.</span><br>"
            "<span style=\"font-size:0.9rem; font-weight:400; color:#1a1a2e; opacity:0.95;\">"
