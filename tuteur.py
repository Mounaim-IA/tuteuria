...
if not chat_actif:
    ...
    with col_p:
        ...
        st.markdown(f"<p style='font-family: Fredoka One; color: #FFD93D; font-size: 1.2rem; margin-bottom: 5px;'>{titre_prenom}</p>", unsafe_allow_html=True)
    ...
    with col_n:
        ...
        st.markdown(f"<p style='font-family: Fredoka One; color: #FFD93D; font-size: 1.2rem; margin-bottom: 5px;'>{titre_niveau}</p>", unsafe_allow_html=True)
