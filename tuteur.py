...
def injecter_consigne_etape(message, etape, langue):
    ...
    consignes = {
        ...
        "exercice2": {
            "Français": "[CONSIGNE SYSTÈME : Pose l'exercice 2 (✏️) : MÊME opération et MÊME type que l'exercice 1 (retrouve-le dans l'historique), MÊME niveau de difficulté, mais avec des nombres DIFFÉRENTS. INTERDIT de changer d'opération. ATTENDS la réponse.]",
            "العربية": "[تعليمات النظام : اطرح التمرين 2 (✏️) : نفس العملية ونفس النوع مثل التمرين 1 (ابحث عنه في المحادثة)، نفس مستوى الصعوبة، لكن بأرقام مختلفة. ممنوع تغيير العملية. انتظر الإجابة.]"
        },
        "quiz": {
            "Français": "[CONSIGNE SYSTÈME : Pose le QUIZ (🎯) — 1 seule question sur la MÊME opération et le MÊME type que les exercices précédents, difficulté équivalente, nombres DIFFÉRENTS. INTERDIT de changer d'opération. ATTENDS la réponse.]",
            "العربية": "[تعليمات النظام : اطرح الاختبار (🎯) — سؤال واحد فقط على نفس العملية ونفس النوع مثل التمارين السابقة، بصعوبة مماثلة وأرقام مختلفة. ممنوع تغيير العملية. انتظر الإجابة.]"
        },
        "felicitations": {
