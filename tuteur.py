...
def post_traitement(reply, user_input, historique, langue):
    ...
    if gpt_faux:
        ...
        if langue == "العربية":
            return (
                f"👏 محاولة جيدة ! 😊 لكن الجواب ليس صحيحاً تماماً.\n"
                f"تذكر الصورة ! 😊 إنها مثالٌ يُريك الخطوات — طبّق هذه الخطوات مع أرقامك.\n"
                f"✏️ حاول مرة أخرى : كم يساوي {expr_str} ؟ 🤔"
            )
        else:
            return (
                f"👏 Bonne tentative ! 😊 Mais ce n'est pas tout à fait ça.\n"
