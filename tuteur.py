...
IMAGES_MAP = {
    "Français": {
        ...
        "tables_multiplication":       "images/fr/09_tables_multiplication.png",
        # Division
...
if user_input:
    ...
    if etape_actuelle == "amorce":
        ...
        if operation:
            ...
            import logging
            logging.warning(f"[DEBUG CAS1] op={operation} niv={niveau_eleve} menu_text={bool(menu_text)} choix_list={bool(choix_list)} niv_min={niv_min}")
    ...
    if etape_actuelle == "hors_niveau":
        ...
        # Détection simple et directe : "1" = oui, "2" = non
        dit_oui = (
        ...
        if dit_oui:
            ...
            # L'élève n'a tapé ni 1 ni 2 — on rappelle les choix, on BLOQUE GPT
            if langue_choisie == "العربية":
                msg_rappel = "😊 اكتب فقط 1 إذا أردت أن تتعلم، أو 2 إذا أردت البقاء في مستواك 🎯"
            else:
                msg_rappel = "😊 Tape juste 1 pour apprendre ou 2 pour rester dans ton niveau 🎯"
            st.session_state[session_key].append(HumanMessage(content=user_input))
