...
if not chat_actif:
    ...
    (function() {{
        function styleActionBtns() {{
            ...
            doc.querySelectorAll('button').forEach(function(btn) {{
                ...
                // Cible uniquement ces deux boutons
            ...
            if (actionRow) {{
                ...
                actionRow.style.setProperty('flex-wrap', 'nowrap', 'important'); 
                actionRow.style.setProperty('justify-content', 'center', 'important'); 
                actionRow.style.setProperty('gap', '4px', 'important'); 
                ...
                cols.forEach(function(c) {{
                    ...
                    var btnW = isMobile ? '42vw' : '120px';
                    c.style.setProperty('width', btnW, 'important');
                    c.style.setProperty('max-width', btnW, 'important');
                    c.style.setProperty('flex', '0 1 ' + btnW, 'important');
    ...
    _, _bn2, _bn4, _ = st.columns([2, 1, 1, 2])
    with _bn2:
...
# Taux réel — minimum 3 réponses pour être significatif
if _total >= 3:
    _taux = round(_bonnes / _total * 100)
elif _total == 2:
    _taux = round(_bonnes / _total * 100) if _bonnes == 2 else round(_bonnes / _total * 50)
elif _total == 1:
    _taux = 50 if _bonnes == 1 else 0
else:
    _taux = 0
