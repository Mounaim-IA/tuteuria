...
(function() {{
    function styleBtns() {{
        ...
        if (targetRow) {{
            ...
            targetRow.style.setProperty('gap', '10px', 'important');           /* Espace entre les boutons */
            ...
            cols.forEach(function(c) {{
                ...
                c.style.setProperty('flex', '1 1 0%', 'important'); /* LA SOLUTION MATHÉMATIQUE (Partage strict sans dépassement) */
