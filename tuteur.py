...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            ...
            "Écris ton <span style='color: #FFFA500;'>prénom</span>, "
            "choisis ton <span style='color: #F8B400;'>niveau</span>, "
            "puis clique sur <span style='color: #FFFFFF;'>Commencer</span> pour débuter !"
            "</div>"
        )
    else:
        titre_html = (
            ...
            "اكتب <span style='color: #FFFFFF;'>اسمك</span>، "
            "اختر <span style='color: #FFFFFF;'>مستواك</span>، "
            "ثم اضغط على <span style='color: #FFFFFF;'>ابدأ</span> للبدء!"
            "</div>"
        )
