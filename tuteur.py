...
<style>
   ...
   /* ══ FORMULAIRE DÉMARRAGE ══ */
    ...
    @media (max-width: 480px) {
        .main .block-container {
            padding: 0 0.3rem 0.5rem 0.3rem !important;
    ...
    /* Force colonnes côte à côte sur tous les écrans */
...
_bn1, _bn2, _bn3, _bn4, _bn5 = st.columns([2, 1, 0.2, 1, 2])
with _bn2:
