...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            ...
            "Écris ton <span style=\"color:#FFAD84; font-weight:600;\">prénom</span>, "
            "choisis ton <span style=\"color:#FF9F1C; font-weight:600;\">niveau</span>, "
            "puis clique sur <span style=\"color:#FF7F50; font-weight:600;\">Commencer</span> pour débuter !"
            "</span>"
        )
    else:
        titre_html = (
            ...
            "<span style=\"font-size:0.95rem; font-weight:400; color:white; opacity:0.95; line-height:1.5;\">"
            "اكتب <span style=\"color:#FF9A3C; font-weight:600;\">اسمك</span>، "
            "اختر <span style=\"color:#FF9A3C; font-weight:600;\">مستواك</span>، "
            "ثم اضغط على <span style=\"color:#FF9A3C; font-weight:600;\">ابدأ</span> للبدء!"
            "</span>"
        )
