    ...
    consignes = {
        ...
        "correction1": {
            "Français": "[CONSIGNE SYSTÈME : La réponse est INCORRECTE. "
                        ...
                        "TEMPS 2 : Modelage (Invente un calcul SIMILAIRE et résous-le complètement devant lui pour montrer l'exemple) "
            ...
            "العربية": "[تعليمات النظام : الإجابة خاطئة. "
                       ...
                       "المرحلة 2 : نمذجة (ابتكر حساباً مشابهاً وقم بحله بالكامل أمامه كـ مثال) "
