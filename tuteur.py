    ...
    try:
        if operation == "addition":
            if "3 chiffres" in c:
                ...
                a_d = random.randint(1, 7); b_d = random.randint(1, 7)
                return f"{a_d*10+a_u}+{b_d*10+b_u}"
            else:
...
def choisir_soustype_auto(operation, niveau, user_input=""):
    ...
    auto = {
        "addition": {
            ...
            2: ("addition_avec_retenue",    "addition à 2 chiffres AVEC retenue, nombres entre 15 et 89"),
        ...
        "soustraction": {
            ...
            2: ("soustraction_avec_retenue",  "soustraction à 2 chiffres AVEC emprunt, nombres entre 20 et 89"),
