...
def verifier_reponse(user_message, historique):
    ...
    # Compatibilité : tuple peut avoir 4 ou 5 éléments
    ...
    try:
        reponse_eleve = int(nombres[0])
    except ValueError:
        return None
    if reponse_eleve == resultat_attendu:
        return 'correct'
    else:
        return f'incorrect:{resultat_attendu}:{"|".join(etapes)}'  
