    ...
    function styleBtns() {{
        ...
        doc.querySelectorAll('button').forEach(function(btn) {{
            ...
            btn.setAttribute('style',
                ...
                'align-items:center !important;' +
                'justify-content:center !important;' +
                'padding:8px 4px !important;' + /* Marge interne réduite */
                'width:100% !important;' +
                'margin:0 !important;' +
        ...
        // L'AJUSTEMENT PARFAIT EN POURCENTAGES
        if (targetRow) {{
            ...
            targetRow.style.setProperty('justify-content', 'center', 'important'); /* Maintient le centrage */
            targetRow.style.setProperty('gap', '10px', 'important'); /* Espace entre les deux boutons */
            ...
            targetRow.style.setProperty('padding', '0 10px', 'important'); /* Protège les bords de l'écran */
            
            var cols = targetRow.querySelectorAll('div[data-testid="column"]');
            cols.forEach(function(c) {{
                c.style.setProperty('width', '100%', 'important');
                c.style.setProperty('max-width', '45%', 'important'); /* LE SECRET: Chaque bouton prend max 45% */
