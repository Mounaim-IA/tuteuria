...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            "<span style=\"font-size:1.05rem; font-weight:400; color:#FAC775;\">🧮 Bienvenue ! "
            "Je suis ton tuteur IA en mathématiques.</span><br>"
            "<span style=\"font-size:0.87rem; font-weight:400; color:#FAC775; opacity:0.9;\">"
            "Veuillez écrire ton prénom, sélectionner un niveau et cliquer sur Commencer."
            "</span>"
        )
    else:
        titre_html = (
            "<span style=\"font-size:1.05rem; font-weight:400; color:#FAC775;\">🧮 مرحباً ! "
