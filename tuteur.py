...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            ...
            "Écris ton <span style=\"color:#2563eb; font-weight:600;\">prénom</span>, "
            "choisis ton <span style=\"color:#E63946; font-weight:600;\">niveau</span>, "
            "puis clique sur <span style=\"color:#8E44AD; font-weight:600;\">Commencer</span> pour débuter !"
            "</span>"
        )
    else:
        titre_html = (
