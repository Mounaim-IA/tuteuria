...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            "<b style=\"font-size:1.05rem; color:white;\">🧮 Bienvenue !</b> "
            "<span style=\"color:white;\">Je suis ton tuteur IA en mathématiques.</span><br>"
        ...
        titre_html = (
            "<b style=\"font-size:1.05rem; color:white;\">🧮 مرحباً !</b> "
            "<span style=\"color:white;\">أنا معلمك الذكي في الرياضيات.</span><br>"
            "<span style=\"font-size:0.87rem; font-weight:600; color:#FF8E8E;\">"
