    ...
    (function() {{
        function styleActionBtns() {{
            ...
            doc.querySelectorAll('button').forEach(function(btn) {{
                ...
                // SÉCURITÉ MAXIMALE : On cible UNIQUEMENT ces deux boutons précis
                var isNew = txt.includes('Recommencer') || txt.includes('\u0645\u0646 \u062c\u062f\u064a\u062f');
                var isDl  = txt.includes('charger') || txt.includes('\u062a\u062d\u0645\u064a\u0644');
                
                // Si c'est un bouton de langue ou Envoyer, on l'ignore complètement !
            ...
            if (actionRow) {{
                ...
                cols.forEach(function(c) {{
                    // LES DEUX BOUTONS SONT FORCÉS À EXACTEMENT 160px
