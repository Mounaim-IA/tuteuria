...
(function() {{
    function styleBtns() {{
        ...
        doc.querySelectorAll('button').forEach(function(btn) {{
            ...
            // 1. Forcer la boîte cachée de Streamlit
            ...
            // 2. Style des boutons DIMINUÉ pour mobile
            btn.setAttribute('style',
                ...
                'border-radius:15px !important;' +
                'font-family:Fredoka One,cursive !important;' +
                'font-size:0.4rem !important;' + /* Taille diminuée */
                'display:flex !important;' +
                'align-items:center !important;' +
                'justify-content:center !important;' +
                'padding:6px 2px !important;' + /* Marges internes diminuées */
                'width:100% !important;' +
                'white-space:normal !important;' + /* AUTORISE LE TEXTE À SE PLIER SI BESOIN */
                'line-height:1.2 !important;'
            );
            
            btn.querySelectorAll('p, span, div').forEach(function(el) {{
                el.style.cssText = 'margin:0 !important;padding:0 !important;text-align:center !important;width:100% !important;color:white !important;font-size:inherit !important;white-space:normal !important;line-height:1.2 !important;';
            }});
        ...
        // 3. Répartition avec marge de sécurité
        if (targetRow) {{
            ...
            targetRow.style.setProperty('gap', '6px', 'important'); 
            targetRow.style.setProperty('width', '100%', 'important');
            targetRow.style.setProperty('padding', '0 4px', 'important'); /* Légère marge pour ne pas coller aux bords de l'écran */
            
            var cols = targetRow.querySelectorAll('div[data-testid="column"]');
            cols.forEach(function(c) {{
                // Calcul affiné pour absorber l'espace sans jamais déborder
                c.style.setProperty('width', 'calc(50% - 4px)', 'important');
                c.style.setProperty('min-width', '0', 'important');
                c.style.setProperty('flex', '0 0 calc(50% - 4px)', 'important');
