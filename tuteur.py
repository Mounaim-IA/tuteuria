...
(function() {{
    function styleBtns() {{
        ...
        doc.querySelectorAll('button').forEach(function(btn) {{
            ...
            btn.querySelectorAll('p, span, div').forEach(function(el) {{
                el.style.cssText = 'margin:0 !important;padding:0 !important;text-align:center !important;width:100% !important;color:white !important;font-size:inherit !important;';
            }});
        ...
        // 3. LA FORCE BRUTE CONTRE L'EMPILEMENT MOBILE DE STREAMLIT
        if (targetRow) {{
            targetRow.style.setProperty('display', 'flex', 'important');
            targetRow.style.setProperty('flex-direction', 'row', 'important'); /* OBLIGE L'ALIGNEMENT HORIZONTAL */
            targetRow.style.setProperty('flex-wrap', 'nowrap', 'important');   /* INTERDIT LE RETOUR À LA LIGNE */
            targetRow.style.setProperty('justify-content', 'center', 'important');
            targetRow.style.setProperty('gap', '4px', 'important');            /* PETIT ESPACE ENTRE LES BOUTONS */
            targetRow.style.setProperty('width', '100%', 'important');
            
            var cols = targetRow.querySelectorAll('div[data-testid="column"]');
            cols.forEach(function(c) {{
                c.style.setProperty('width', '50%', 'important');        /* FORCE 50% de l'espace */
                c.style.setProperty('min-width', '0px', 'important');    /* DÉSACTIVE LA SÉCURITÉ MOBILE STREAMLIT */
                c.style.setProperty('flex', '1 1 50%', 'important');     /* OBLIGE le partage équitable */
    ...
    // Exécution rapide et en boucle pour contrer Streamlit
