...
(function() {{
    function styleBtns() {{
        ...
        doc.querySelectorAll('button').forEach(function(btn) {{
            ...
            // FORMAT "PILULE" IDENTIQUE AUX BOUTONS DE LANGUES
            btn.setAttribute('style',
                'background:#4ECDC4 !important;' +
                'color:white !important;' +
                'border:none !important;' +
                'border-radius:50px !important;' + /* Effet Pilule très arrondi */
                'font-family:Fredoka One,cursive !important;' +
                'font-size:0.95rem !important;' + /* Même taille de police que les langues */
                'display:flex !important;' +
                'align-items:center !important;' +
                'justify-content:center !important;' +
                'padding:8px 12px !important;' + 
        ...
        if (targetRow) {{
            // CENTRAGE PARFAIT ET TAILLE FIXE COMPACTE
            targetRow.style.setProperty('display', 'flex', 'important');
            targetRow.style.setProperty('flex-direction', 'row', 'important');
            targetRow.style.setProperty('justify-content', 'center', 'important'); /* Centre le duo au milieu de l'écran */
            targetRow.style.setProperty('gap', '20px', 'important'); /* Bel espace entre les deux boutons */
            ...
            cols.forEach(function(c) {{
                c.style.setProperty('width', '140px', 'important'); /* Taille exacte compacte */
                c.style.setProperty('max-width', '140px', 'important');
                c.style.setProperty('min-width', '0', 'important');
                /* flex: 0 1 140px signifie : Reste à 140px, mais rétrécis si on est sur un tout petit téléphone */
                c.style.setProperty('flex', '0 1 140px', 'important'); 
