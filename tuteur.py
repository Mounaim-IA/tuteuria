...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            ...
            "Écris ton <span style=\"color:#D4AF37; font-weight:600;\">prénom</span>, "
            "choisis ton <span style=\"color:#FFEA00; font-weight:600;\">niveau</span>, "
            "puis clique sur <span style=\"color:#D4AF37; font-weight:600;\">Commencer</span> pour débuter !"
            "</span>"
        )
    else:
        titre_html = (
