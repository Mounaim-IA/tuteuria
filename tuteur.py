    ...
    function styleBtns() {{
        ...
        doc.querySelectorAll('button').forEach(function(btn) {{
            ...
            btn.setAttribute('style',
                ...
                'width:100% !important;' +
                'max-width:100% !important;' + /* On enlève la limite en pixels, la grille gère */
                'margin:0 !important;' +
                'white-space:normal !important;' + /* CRUCIAL: Autorise le texte à passer sur 2 lignes si l'écran est minuscule */
                'word-wrap:break-word !important;' +
                'line-height:1.2 !important;'
            );
            
            btn.querySelectorAll('p, span, div').forEach(function(el) {{
                el.style.cssText = 'margin:0 !important;padding:0 !important;text-align:center !important;width:100% !important;color:white !important;font-size:inherit !important;white-space:normal !important;';
            }});
        ...
        // LA MAGIE DE LA GRILLE (Coupe l'espace en 2 cases égales strictes)
        if (targetRow) {{
            targetRow.style.setProperty('display', 'grid', 'important');
            targetRow.style.setProperty('grid-template-columns', '1fr 1fr', 'important'); /* 2 moitiés parfaites */
            targetRow.style.setProperty('gap', '6px', 'important'); /* L'espace entre les 2 boutons */
            targetRow.style.setProperty('width', '100%', 'important');
            targetRow.style.setProperty('max-width', '100%', 'important');
