                ...
                if _img_path and _choix_consigne and etape_actuelle == "explication":
                    ...
                    if langue_choisie == "العربية":
                        if is_pb:
                            ...
                            consigne_specifique = (
                                f"[تعليمات النظام : صورة معروضة فوقك. اكتب 5 أسطر بدون قوائم. "
                                f"قل 'انظر للصورة ! 😊' ثم اشرح بجملتين : "
                                f"السطر الأول = الآحاد تضرب الكل، السطر الثاني = العشرات تضرب الكل + نقطة •، ثم جمع السطرين. "
                                f"اختم بـ '✏️ دورك !' مع تمرين من نوع : {_choix_consigne}.]"
                            )
                        else:
                            consigne_specifique = (
                                f"[تعليمات النظام : صورة معروضة. اكتب 4-5 أسطر بدون قوائم أو نجوم. "
                                f"جملة تشبيه قصيرة من الحياة اليومية، "
                                f"ثم 'انظر للصورة ! 😊'، "
                                f"ثم طريقة ذهنية واحدة بجملة، "
                                f"ثم '✏️ دورك !' مع تمرين من نوع : {_choix_consigne} بأرقام مختلفة عن الصورة.]"
                            )
                    else:
                        if is_pb:
                            consigne_specifique = (
                                f"[CONSIGNE : Problème énoncé. Écris 5-6 lignes sans listes ni astérisques. "
                                f"Demande 'Qu'est-ce qu'on sait ? Qu'est-ce qu'on cherche ?' puis identifie l'opération et résous. "
                                f"Termine par '✏️ À toi !' avec un problème similaire.]"
                            )
                        elif is_2x2:
                            consigne_specifique = (
                                f"[CONSIGNE : Image affichée. Écris 5 lignes sans listes. "
                                f"Dis 'Regarde bien l'image ! 😊' puis explique en 2 phrases : "
                                f"ligne 1 = les unités multiplient tout, ligne 2 = les dizaines multiplient tout + un point •, puis on additionne les deux lignes. "
                                f"Termine par '✏️ À toi !' avec un exercice de type : {_choix_consigne}.]"
                            )
                        else:
                            consigne_specifique = (
                                f"[CONSIGNE : Image affichée. Écris 4-5 lignes sans listes ni astérisques. "
                                f"Une phrase de comparaison concrète de la vie quotidienne, "
                                f"puis 'Regarde bien l'image ! 😊', "
                                f"puis une astuce mentale en une phrase, "
                                f"puis '✏️ À toi !' avec un exercice de type : {_choix_consigne} avec des nombres du même ordre que l'image.]"
                            )
                    ...
                    if langue_choisie == "العربية":
                        if is_pb:
                            consigne_specifique = (
                                f"[تعليمات النظام : مسألة، لا توجد صورة. "
                                f"اكتب 5 أسطر بدون قوائم. حدد العملية وحل خطوة بخطوة. "
                                f"اختم بـ '✏️ دورك !' بمسألة مشابهة. لا تقل أبداً 'انظر للصورة'.]"
                            )
                        else:
                            consigne_specifique = (
                                f"[تعليمات النظام : لا توجد صورة. اكتب 4-5 أسطر بدون قوائم أو نجوم. "
                                f"جملة تشبيه من الحياة اليومية، ثم طريقة ذهنية واحدة بجملة، "
                                f"ثم '✏️ دورك !' مع تمرين من نوع : {_choix_consigne}. "
                                f"لا تقل أبداً 'انظر للصورة'.]"
                            )
                    else:
                        if is_pb:
                            consigne_specifique = (
                                f"[CONSIGNE : Problème, pas d'image. "
                                f"Écris 5 lignes sans listes. Identifie l'opération et résous pas à pas. "
                                f"Termine par '✏️ À toi !' avec un problème similaire. Ne dis jamais 'Regarde l'image'.]"
                            )
                        else:
                            consigne_specifique = (
                                f"[CONSIGNE : Pas d'image. Écris 4-5 lignes sans listes ni astérisques. "
                                f"Une phrase de comparaison concrète, puis une astuce mentale en une phrase, "
                                f"puis '✏️ À toi !' avec un exercice de type : {_choix_consigne}. "
