...
def detecter_image_operation(message, reponse_tuteur, niveau, langue):
    ...
    if any(mot in msg for mot in ["addition", "جمع"]):
        ...
        if any(mot in msg for mot in ["3 chiffres", "centaine", "ثلاث", "مئ"]): return images.get("addition_3_chiffres")
        if any(mot in msg for mot in ["retenue", "احتفاظ"]): return images.get("addition_avec_retenue")
