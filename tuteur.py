...
if not chat_actif:
    ...
    if langue_choisie == "Français":
        titre_html = (
            ...
            "Écris ton <span style=\"color:white; font-weight:700; border-bottom: 3px solid #FFD93D;\">prénom</span>, "
            "choisis ton <span style=\"color:white; font-weight:700; border-bottom: 3px solid #FFD93D;\">niveau</span>, "
            "puis clique sur <span style=\"color:white; font-weight:700; border-bottom: 3px solid #FFD93D;\">Commencer</span> pour débuter !"
            "</span>"
        )
    else:
        titre_html = (
            ...
            "<span style=\"font-size:0.95rem; font-weight:400; color:white; opacity:0.95; line-height:1.5;\">"
            "اكتب <span style=\"color:white; font-weight:700; border-bottom: 3px solid #FFD93D;\">اسمك</span>، "
            "اختر <span style=\"color:white; font-weight:700; border-bottom: 3px solid #FFD93D;\">مستواك</span>، "
            "ثم اضغط على <span style=\"color:white; font-weight:700; border-bottom: 3px solid #FFD93D;\">ابدأ</span> للبدء!"
            "</span>"
        )
