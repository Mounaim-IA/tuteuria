...
def choisir_soustype_auto(operation, niveau, user_input=""):
    ...
    auto = {
        ...
        "multiplication": {
            2: ("tables_multiplication",      "tables de multiplication de 1 à 9, produit simple entre 1×1 et 9×10"),
    ...
    if not sous_types:
        ...
        if niv_min:
            if langue == "العربية":
                ...
                }.get(niv_num, "l'addition et la soustraction")
                noms_fr2 = {
                    "multiplication": "la multiplication",
                    "division"      : "la division",
                }
